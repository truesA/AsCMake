package com.achers.ascmake.circlefriends.main;
...
import com.achers.ascmake.circlefriends.BGANinePhotoLayout;
import com.achers.ascmake.circlefriends.BGAOnRVItemClickListener;
import com.achers.ascmake.circlefriends.BGAOnRVItemLongClickListener;
import com.achers.ascmake.circlefriends.BGARecyclerViewAdapter;
import com.achers.ascmake.circlefriends.BGAViewHolderHelper;
import com.achers.ascmake.circlefriends.imageloader.BGARVOnScrollListener;
import com.achers.ascmake.circlefriends.model.Moment;
...
public class MomentListActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks, BGANinePhotoLayout.Delegate, BGAOnRVItemClickListener, BGAOnRVItemLongClickListener {
    ...
    private void addNetImageTestData() {
        ...
        moments.add(new Moment("1张网络图片", new ArrayList<>(Arrays.asList("https://osstea.oss-cn-huhehaote.aliyuncs.com/user/2019/6/c9b57edd-96be-4621-bc5a-fb713ca500a7.jpg"))));
        moments.add(new Moment("2张网络图片", new ArrayList<>(Arrays.asList("http://7xk9dj.com1.z0.glb.clouddn.com/refreshlayout/images/staggered2.png", "https://osstea.oss-cn-huhehaote.aliyuncs.com/user/2019/6/4d785103-ad8f-4f97-ac09-ea7640390437.jpg"))));
        ...
        moments.add(new Moment("3张网络图片", new ArrayList<>(Arrays.asList("http://7xk9dj.com1.z0.glb.clouddn.com/refreshlayout/images/staggered4.png", "https://osstea.oss-cn-huhehaote.aliyuncs.com/user/2019/6/7f8f85e8-e0fa-407c-ba2f-09feaf6c5148.jpg", "http://7xk9dj.com1.z0.glb.clouddn.com/refreshlayout/images/staggered6.png"))));
