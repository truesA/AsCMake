 ...
 * Remarks:
 */
public class SortDetailFragment2 extends BaseFragment<SortDetailPresenter, String> implements CheckListener {
    private RecyclerView mRv;
    private ClassifyDetailAdapter2 mAdapter;
    private GridLayoutManager mManager;
    private List<RightBean2> mDatas = new ArrayList<>();
    private ItemHeaderDecoration2 mDecoration;
    ...
    protected void initListener() {
        mRv.addOnScrollListener(new SortDetailFragment2.RecyclerViewListener());
    }
...
//                return mDatas.get(position).isTitle() ? 3 : 1;
        ...
        mAdapter = new ClassifyDetailAdapter2(mContext, mDatas, new RvListener() {
            @Override
...
//                text.setTextSize(25);
        ...
        mDecoration = new ItemHeaderDecoration2(mContext, mDatas);
    ...
    private void initData() {
        ...
        for (int i = 0; i < rightList.size(); i++) {
            RightBean2 head = new RightBean2();
            //头部设置为true
            head.setIsTitle(1);
            ...
            for (int j = 0; j < categoryTwoArray.size(); j++) {
                RightBean2 body = new RightBean2();
                body.setIsTitle(2);
