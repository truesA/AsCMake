...
public class ItemHeaderDecoration2 extends RecyclerView.ItemDecoration {
    private int mTitleHeight;
    private List<RightBean2> mDatas;
    ...
    ItemHeaderDecoration2(Context context, List<RightBean2> datas) {
        this.mDatas = datas;
    ...
    public ItemHeaderDecoration2 setData(List<RightBean2> mDatas) {
        this.mDatas = mDatas;
        return this;
    }

    public static void setCurrentTag(String currentTag) {
        ItemHeaderDecoration2.currentTag = currentTag;
    }
