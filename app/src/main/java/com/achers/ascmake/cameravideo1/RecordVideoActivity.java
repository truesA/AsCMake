...
import com.achers.ascmake.cameravideo1.widget.RecordVideoView;
import com.achers.ascmake.cameravideo1.widget.SendView;
...
public class RecordVideoActivity extends AppCompatActivity {
    ...
    private void onSaveRecord() {
        ...
        Toast.makeText(RecordVideoActivity.this, "文件位置"+mRecordVideoFragment.getVideoFilePath(), Toast.LENGTH_LONG).show();
        Intent intent = new Intent();
        intent.putExtra("video_url",mRecordVideoFragment.getVideoFilePath());
