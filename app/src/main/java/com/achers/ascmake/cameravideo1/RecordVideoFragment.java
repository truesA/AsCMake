...
import com.achers.ascmake.cameravideo1.helper.CameraHelper;
...
//        mOutputVideoFile = CameraHelper.getOutputMediaFile(CameraHelper.MEDIA_TYPE_VIDEO);
        mOutputVideoFile = createCameraTempImageFile();
        ...
        if (!dir.exists() || !dir.isDirectory()) {
            if (!dir.mkdirs()) {
                ...
                if (null == dir || !dir.exists()) {
                    ...
                    if (null == dir || !dir.exists()) {
                        String cacheDirPath = File.separator + "data" + File.separator + "data" + File.separator + getActivity().getPackageName() + File.separator + "cache" + File.separator;
