 ...
 * Remarks:
 */
public class CollapsingToolbarLayoutTextActivity extends AppCompatActivity {
            ...
            public void onRefresh() {
                mRefreshLayout.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(CollapsingToolbarLayoutTextActivity.this, "刷新完毕", Toast.LENGTH_SHORT).show();
