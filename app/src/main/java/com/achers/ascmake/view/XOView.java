...
public class XOView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        paintBlueC.setColor(Color.BLUE);
        paintBlueC.setStrokeWidth(10);
        paintBlueC.setStyle(Paint.Style.STROKE);

        paintRedX = new Paint();
        paintRedX.setColor(Color.RED);
        paintRedX.setStrokeWidth(10);


        paintHuiC = new Paint();
        paintHuiC.setColor(Color.parseColor("#88888888"));
        paintHuiC.setStrokeWidth(10);
        paintHuiC.setStyle(Paint.Style.STROKE);

        PaintHuiX = new Paint();
        PaintHuiX.setColor(Color.parseColor("#88888888"));
        PaintHuiX.setStrokeWidth(10);
    }
...
//        rect.bottom = height - paddingBottom;
        ...
        if (status == 0) { //蓝圈
            canvas.drawCircle(getWidth() / 2, getWidth() / 2, getWidth() / 2 - 10-getPaddingTop(), paintBlueC);
