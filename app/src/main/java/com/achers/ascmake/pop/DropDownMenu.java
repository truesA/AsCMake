package com.achers.ascmake.pop;

/**
 * Create on 2018/3/10 20:54
 * <p>
 * author lhm
 * <p>
 * Description:
...
public class DropDownMenu extends LinearLayout {
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        params.setMargins(dpTpPx(15),dpTpPx(5),dpTpPx(15),dpTpPx(5));
        ...
        if (i < tabTexts.size() - 1) {
            ...
            view.setBackgroundColor(Color.WHITE);//dividerColor
