...
public class VideoCompressorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_video_commpressor);
        initActionBar();
    ...
    private void getPermission() {
        ...
        if (params != null && params.length > 0) {
            ActivityCompat.requestPermissions(VideoCompressorActivity.this,
                    params,
                    100);
        } else {
            uploadVideo();
...
//                }
    ...
    private void executeCutVideo(final int startMs, final int endMs) {
        ...
        String fileExtn = ".mp4";
        final String selectVideoPath = getPath(VideoCompressorActivity.this, selectedVideoUri);
...
//        filePath = dest.getAbsolutePath();
     ...
     * 录制视频的保存输出地址
     */
    private File createCameraTempImageFile() {
        File mTempImageFile = null;
        ...
        if (!dir.exists() || !dir.isDirectory()) {
            if (!dir.mkdirs()) {
                ...
                if (null == dir || !dir.exists()) {
                    ...
                    if (null == dir || !dir.exists()) {
                        String cacheDirPath = File.separator + "data" + File.separator + "data" + File.separator + this.getPackageName() + File.separator + "cache" + File.separator;
        ...
        try {
            mTempImageFile = File.createTempFile("VID", ".mp4", dir);
        } catch (IOException e) {
            e.printStackTrace();
            mTempImageFile = null;
        }
