...
import com.achers.ascmake.bamboy.util.UtilAnim;
import com.achers.ascmake.bamboy.util.UtilBitmap;
import com.achers.ascmake.bamboy.util.UtilScreenCapture;

/**
 * author：lhm on 2018/4/15 13:15
 * <p>
 * email：3186834196@qq.com
 */
public class BamActivity extends Activity implements View.OnClickListener {
    ...
    private TextView tv_blur_fragment;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.activity_bam_boy);
        ...
        tv_blur_fragment=(TextView) findViewById(R.id.tv_blur_fragment);

        tv_blur_img.setOnClickListener(this);
        tv_blur_popup_window.setOnClickListener(this);
        tv_blur_fragment.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_close_popup_window: // 关闭弹窗
                ...
                break;
            case R.id.tv_blur_fragment:
                KefuOrderDialogFragment fragment=KefuOrderDialogFragment.newInstance("",this);
    ...
    private void clickPopupWindow() {
        ...
        Swap.getInstance().setBitmap(bitmap);
        if (bitmap != null) {
            // 将截屏Bitma放入ImageView
