...
import kotlinx.android.synthetic.main.see_photo_layout.*


/**
 * Created on 2019/2/2 14:01
 * <p>
 * author lhm
 * <p>
 * Description:
 ...
 * Remarks:
 */
class SeePhotoActivity : SlideBackActivity() {
...
//                                Glide.with(imageView).load(list[position]).apply(RequestOptions().override(Target.SIZE_ORIGINAL))
//                                        .into(imageView)
//                            }
...
//        piv.imageMatrix = matrix
        ...
        iv.setOnClickListener {
            ...
            XPopup.get(this)
                    .asImageViewer(iv, list2[0], ImageLoader())
                    .show()
...
//                piv.translationX = evaluator.evaluate(it.animatedFraction, startX, 0).toFloat()
    ...
    internal inner class ImageLoader : XPopupImageLoader {
        override fun loadImage(position: Int, @NonNull url: String, @NonNull imageView: ImageView) {
